...
type Response struct {
	...
	// StatusCode is the HTTP Status Code returned by the HTTP Response. Taken from res.StatusCode
	StatusCode int

	// Body is the main data returned by the http request
	Body io.ReadCloser
	...
	// Request is the HTTP Request Taken from res.Request
	Request *http.Request
}

// buildResponse  converts http into a custom response
func buildResponse(res *http.Response, err error) (*Response, error) {
...
/*
Close is part of our ability to support io.ReadCloser
...
/*
JSON is a method that will populate a struct that is provided `userStruct` with the JSON returned
...
/*
populateResponseByteBuffer is a utility method that will populate the internal byte reader
this is largely used for .String() and .Bytes()
*/
